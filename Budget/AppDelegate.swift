...
//  Budget
//
//  Created by Calebe Santos on 3/30/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        navigationBarAppearace.backgroundColor = Color.uicolorFromHex(0x274561)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "br.com.budget.Budget" in the application's documents Application Support directory.
